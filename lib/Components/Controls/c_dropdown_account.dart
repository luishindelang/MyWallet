...
class CDropdownAccount extends StatelessWidget {
  const CDropdownAccount({
    super.key,
    required this.value,
  ...
  final DsAccount? value;
  final List<DsAccount> options;
  final Function(DsAccount) onChanged;
  final String hint;
